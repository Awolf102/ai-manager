...
**Seven cycles shipped (S2, U1, P1, P2, S1, then S3+S4 batched — all merged to main).** Remaining:
**S5, P3, R1, R2, R3 + the NEW OS-level-sandbox spike** (from S1's residual). Guidance for running them efficiently:
