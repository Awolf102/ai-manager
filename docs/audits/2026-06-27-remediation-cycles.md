...
**Eight cycles shipped (S2, U1, P1, P2, S1, S3+S4 batched, S5 — all merged to main).** Remaining:
**P3, R1, R2, R3 + the NEW OS-level-sandbox spike** (from S1's residual). Guidance for running them efficiently:
